...
frappe.ui.form.on('Shipment', {
	...
	print_shipping_label: function (frm) {
		frappe.call({
			method: "erpnext_dhlshipping.erpnext_dhlshipping.shipping.print_shipping_label",
			freeze: true,
	...
	update_tracking: function (frm, service_provider, shipment_id) {
		...
		frappe.call({
			method: "erpnext_dhlshipping.erpnext_dhlshipping.shipping.update_tracking",
			freeze: true,
...
function select_from_available_services(frm, available_services) {
	...
	frm.select_row = function (service_data) {
		frappe.call({
			method: "erpnext_dhlshipping.erpnext_dhlshipping.shipping.create_shipment",
			freeze: true,
